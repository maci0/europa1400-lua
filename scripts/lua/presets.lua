...
--
--   presets = dofile('lua/presets.lua')
...
M.entries = {
    ...
    { key="building",  tags={"building","gebaeude","haus","workshop","werkstatt","warehouse","lager","upgrade","Upgrade","level","Level","hire","Hire","worker","Worker","durability","Durability","income","Income","efficiency","Effizienz","moral","morale","Morale","upkeep","Upkeep","Unterhalt","capacity","Capacity","Kapazitaet","servant","Servant","Diener","slots","Slots","harvest","Harvest","Ernte","rent","Rent","Miete","security","Security","Sicherheit","value","Value","Wert","accident","Accident","Unfall","fire","Fire","Feuer","strike","Strike","Streik","bonus","Bonus","apprentice","Apprentice","Lehrling","granary","Granary","Speicher","baker","Baker","Bäcker","master","Master","Meister","brewery","Brewery","Brauerei","mill","Mill","Mühle","blacksmith","Blacksmith","Schmied","tannery","Tannery","Gerberei","weaver","Weaver","Weber","mint","Mint","Münze","herb","Herb","Kraut","vineyard","Vineyard","Weinberg","pottery","Pottery","Töpferei","tailor","Tailor","Schneider","fishing","Fishing","Fischerei","orchard","Orchard","Obstgarten","carpenter","Carpenter","Zimmermann","ropemaker","Ropemaker","Seiler","apiary","Apiary","Imkerei","hunting","Hunting","Jagd","alchemist","Alchemist","Alchemist","glassworks","Glassworks","Glas","mason","Mason","Steinmetz","distillery","Distillery","Brennerei","pasture","Pasture","Weide","quarry","Quarry","Steinbruch","forge","Forge","Schmiede","sawmill","Sawmill","Sägewerk","kiln","Kiln","Ofen","foundry","Foundry","Gießerei","apothecary","Apothecary","Apotheke","scribe","Scribe","Schreiber","goldsmith","Goldsmith","Goldschmied","falconer","Falconer","Falkner","jeweler","Jeweler","Juwelier","bathhouse","Bathhouse","Badehaus","perfumer","Perfumer","Parfum","soapmaker","Soapmaker","Seife","candlemaker","Candlemaker","Kerze","papermill","Papermill","Papier","printing","Printing","Druck","toolmaker","Toolmaker","Werkzeug","charcoal","Charcoal","Kohle","furrier","Furrier","Kürschner","dyer","Dyer","Färber","saddler","Saddler","Sattler","armorer","Armorer","Plattner","bowyer","Bowyer","Bogen","cartwright","Cartwright","Wagner","mint","Mint2","winery","Winery","Kelter","shipwright","Shipwright","Schiff","cooper","Cooper","Böttcher","spinner","Spinner","Spinner","turner","Turner","Drechsler","barber","Barber","Barbier","stonecutter","Stonecutter","Steinmetz","cobbler","Cobbler","Schuster","butcher","Butcher","Metzger","baker2","Baker2","shepherd","Shepherd","Schäfer","dairy","Dairy","Molke","brewmaster","Brewmaster","Braumeister","miller","Miller","Müller","fishery","Fishery","chandler","Chandler","Kerzen","goldbeater","Goldbeater","Gold","potter","Potter","Töpfer","fowler","Fowler","Vogel","vintner","Vintner","Wein","dowry","Dowry","Mitgift","wedding","Wedding","Hochzeit"} },
    { key="quest",     tags={"quest","Quest","Aufgabe","mission","Mission"} },
    { key="reputation",tags={"reputation","Reputation","Ruf","Ansehen","fame","dynasty","Dynastie","espionage","Espionage","Spionage","spy","Spy","network","Network","intrigue","Intrige","bribe","Bestechung","title","Titel","aggress","Aggress","faith","Faith","Glaube","piety","Piety","Froemmig","tithe","Tithe","Zehnten","AI","Verhalten","behavior","Behavior","court","Court","Hof","favor","Favor","Gunst","poison","Poison","Gift","assassin","Assassin","drunk","Drunk","Betrunken","apprentice","Apprentice","Lehrling","master","Master","evidence","Evidence","Beweis","trait","Trait","Charakter","kidnap","Kidnap","Entfuehr","ransom","Ransom","Loesegeld","honor","Honor","Ehre","trade","Trade","Handel","feast","Feast","Fest","favor","Favor","ambassador","Ambassador","Botschafter","bounty","Bounty","charter","Charter","xp","XP","donation","Donation","experience","Experience","noble","Noble","Adel","bandit","Bandit","suspicion","Suspicion","imperial","Imperial","Kaiser","plague","Plague","Pest","tavern","Tavern","Taverne","monastery","Monastery","Kloster","apprentice","Apprentice","gambling","Gambling","Gluecksspiel","banquet","Banquet","Bankett","decay","Decay","sin","Sin","Suende","confession","Confession","Beichte","excommunication","Excommunication","promotion","Promotion","Beförderung","pilgrim","Pilgrim","relic","Relic","crusade","Crusade","Kreuzzug","university","University","Universität","guard","Guard","morale","Morale","joust","Joust","tournament","Tournament","inquisition","Inquisition","smuggler","Smuggler","brewery","Brewery","cartel","Cartel","fence","Fence","jester","Jester","bard","Bard","mill","Mill","harbor","Harbor"} },
...
function M.hunt(key, base, size, opts)
    ...
    if not finder then
        local ok, m = pcall(dofile, "lua/finder.lua")
        if not ok then error("finder not loadable: " .. tostring(m)) end
        finder = m
    end
...
function M.apply(key, base, size, signature, prefix)
    ...
    if signature and #hits > 0 then
        local finder = _G.finder
        if not finder then local ok, m = pcall(dofile, "lua/finder.lua"); if ok then finder = m end end
        if finder and finder.register_hits then
